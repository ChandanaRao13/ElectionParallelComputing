		...
		for(int index = 0; index < 3;index++){
			if(candidates[index] >=260){
				if(index == 0)
					...
					std::cout << "\n The New President of United States Of America is " << candidate2 << " !!!!!!!\n";
				else
					std::cout << "\n The New President of United States Of America is " << candidate3 << " !!!!!!!\n";
